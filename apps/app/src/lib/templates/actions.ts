    ...
    messages: [
      {
        ...
        content: payload.currentHtml
          ? `Starting from this e-mail template:${payload.currentHtml}\n${payload.prompt}`
          : `${payload.prompt}`,
      },
    ],
  });
